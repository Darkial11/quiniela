...
class Partido(models.Model):
    ...
    jornada = models.ForeignKey(
        Jornada, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    pais_sede = models.CharField(max_length=100, blank=True, null=True)
    resultado_real = models.CharField(max_length=1, blank=True, null=True)
...
class Pago(models.Model):
    ...
    monto = models.DecimalField(max_digits=6, decimal_places=2, default=30.00)
