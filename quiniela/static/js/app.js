...
(function() {
    ...
    // Recolectar todos los nombres únicos de participantes
    ...
    // Crear un botón por cada participante
    ...
    function aplicarFiltro() {
        ...
        document.querySelectorAll('.jornada-box tbody tr').forEach(fila => {
            ...
            if (seleccionados.size === 0) {
                ...
                fila.style.display = seleccionados.has(nombre.innerText.trim())
                    ? ''
                    : 'none';
